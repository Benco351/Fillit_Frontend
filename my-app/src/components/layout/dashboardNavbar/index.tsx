  ...
  return (
    <ThemeProvider theme={NavBarTheme}>
      <ElevationScroll>
        <AppBar
          position="fixed"
          color="secondary" // Set the AppBar color to secondary
          sx={{
            transition: 'all 0.3s',
            backdropFilter: scrolled ? 'blur(10px)' : 'none',
            backgroundColor: scrolled
              ? alpha(NavBarTheme.palette.secondary.main, 0.8) // Use secondary color when scrolled
              : NavBarTheme.palette.secondary.main, // Use secondary color when not scrolled
          }}
        >
          <Container>
